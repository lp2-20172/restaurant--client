...
import {del, getList} from '../../../actions/mesa-action'
...
class List extends Component {
    ...
    handleClick = () => {
        this.props.history.push('/catalogo/mesa/new');
    }
                            ...
                            {list.map((d, index) =>
                                <tr key={index}>
                                    ...
                                    <td className="text-center">
                                        <Link to={`/catalogo/mesas/edit/${d.id}`}  className="btn btn-info btn-sm"
